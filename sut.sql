...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2024 at 03:31 AM
...
(10, 'พัชรี', 'ศรีอ่อนหล้า', 'พัชรี.png', 'บุคลากร');
...
(1, 'ศูนย์นวัตกรรมและเทคโนโลยีการศึกษา', 'ถนน 111 ถนน มหาวิทยาลัย ต.สุรนารี อ.เมือง จ.นครราชสีมา', '0884499588', 'ceit@sut.ac.th');
...
CREATE TABLE `exam_schedule` (
  ...
  `exam_start_times` time NOT NULL,
  `exam_end_times` time NOT NULL,
...
INSERT INTO `exam_schedule` (`exam_id`, `exam_date`, `exam_start_times`, `exam_end_times`, `num_proctors`, `created_at`, `updated_at`, `exam_type_id`) VALUES
(13, '2024-11-25', '01:30:00', '02:30:00', 4, '2024-11-25 07:26:25', '2024-11-25 08:38:45', 1),
(14, '2024-11-30', '01:30:00', '02:30:00', 1, '2024-11-25 07:26:25', '2024-11-25 09:33:44', 1),
(15, '2024-12-01', '00:30:00', '00:45:00', 8, '2024-11-25 07:26:55', '2024-11-25 09:34:40', 2),
(16, '2024-11-25', '14:30:00', '15:30:00', 5, '2024-11-25 07:26:55', '2024-11-25 08:38:26', 2);
...
CREATE TABLE `user` (
  ...
  `amout_hour` int(11) NOT NULL COMMENT 'จำนวนคาบที่มี',
...
INSERT INTO `user` (`user_id`, `personal_id`, `username`, `password`, `name`, `lastname`, `email`, `phone`, `tel`, `user_type`, `status`, `amout_hour`, `ag_id`) VALUES
(5, 1001, 'admin', '1234', 'admin', '1234', '', '', '', 1, 1, 16, 1),
(7, 1002, '1234', '1234', '1234', '1234', '', '', '', 1, 1, 4, 0),
(12, 1003, 'ice', '1234', 'ดาราวรรณ', 'พรมลักษ์', '', '081-112', '-', 1, 1, 3, 6),
(13, 1004, 'pad123', '1234', 'พัชรี', 'ศรีอ่อนหล้า', '', '', '', 1, 1, 5, 7),
(15, 1005, 'riri', '1234', 'เบิร์ด', 'สักลาย', '', '', '', 2, 1, 15, 5),
(16, 1006, 'maga', '1234', 'พั้นซ์', 'รักแมว', '', '', '', 2, 1, 5, 1),
(17, 1007, 'yuri', '1234', 'น้องแมส', 'พี่กล้วย', '', '', '', 2, 1, 6, 4),
(18, 1008, 'nana', '1234', 'พัชรี', 'พัชรี', '', '', '', 1, 1, 3, 6);
...
--
ALTER TABLE `about`
  MODIFY `about_no` int(11) NOT NULL AUTO_INCREMENT COMMENT 'เลขที่เกี่ยวกับ', AUTO_INCREMENT=11;
