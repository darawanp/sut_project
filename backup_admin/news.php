...
<head>
    ...
    <title>ข่าวประชาสัมพันธ์ - Admin Management</title>
        ...
        <section class="section">
            <div class="card">
                <div class="card-site d-flex align-items-center">
                    <h5 class="card-title me-3">ข่าวประชาสัมพันธ์  |</h5>
                    <form name="form1" action="news.php" method="get" class="form-inline">
                ...
                if (isset($_GET['search_news']) && !empty($_GET['search_news'])) {
                    ...
                    $sql = "SELECT * FROM news WHERE news_type=1 
