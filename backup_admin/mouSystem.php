    ...
    <section class="section-padding">
        <div class="container">
            <div class="col-lg-10 col-12 text-center mx-auto">
                <h5 class="mb-2" style="font-weight:400; font-size:22px;">ข้อมูลการลงนามนี้ดำเนินการโดย <span style="color: #FF9900;"><?php echo $_SESSION['campus']; ?></span></h5>
                <h5 class="mb-4" style="font-weight:400; font-size:20px;">กรุณากรอกข้อมูลทั้งหมดให้ครบถ้วน<span class="ms-2" style="color: red; font-size:25px;">!</span></h5>
            </div>
                ...
                <div class="row">
                    <form name="upfile" action="mouInsert.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="deptNameCo" value="<?php echo $deptNameCo; ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">
                                        ต่างประเทศ   โปรดระบุ ประเทศ: <input type="text" class="form-input" name="CountyName" value="<?php echo $CountyName; ?>"> 
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="depAddress" class="form-control" style="height: 75px;"><?php echo $depAddress; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">ระยะเวลาของบันทึกความร่วมมือ  <input type="number" class="form-input col-md-2 text-center" name="time_mou" value="<?php echo $time_mou; ?>"> ปี</label>
                        </div>
                        <div class="d-flex mb-3">
                            <div class="col-lg-6 d-flex me-2">
                                <label class="form-label col-md-3" style="padding-top: 5px;">วันที่ลงนาม</label>
                                <input type="date" class="form-control" name="dateStart" value="<?php echo $dateStart; ?>">
                            </div>
                            <div class="col-lg-6 d-flex ">
                                <label class="form-label col-md-3" style="padding-top: 5px;">วันที่หมดอายุ</label>
                                <input type="date" class="form-control" name="dateExpired" value="<?php echo $dateExpired; ?>">
                            </div>
                        </div>
                        <div class="mb-5">
                            ...
                            <div class="d-flex">
                                <div class="col-lg-6">
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" style="margin-left: 4.75rem;" name="renewal" value="1" <?php echo ($renewal=="1" ? 'checked' : ''); ?>>
                                        <label class="form-check-label">
                            ...
                            <div class="d-flex">
                                <div class="col-lg-6">
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" style="margin-left: 4.75rem;" name="renewal" value="3" <?php echo ($renewal=="3" ? 'checked' : ''); ?>>
                                        <label class="form-check-label col-lg-8">
                                            ต่ออายุอัตโนมัติ <input type="number" class="form-input col-md-2 text-center" name="renewaltime" value="<?php echo $renewaltime; ?>"> ปี นับจากวันที่ลงนาม
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div hidden>
                            <label class="form-label col-lg-4" style="padding-top: 5px;">หน่วยงาน มทร.อีสาน ที่ดำเนินการ</label>
                            <input type="text" class="form-control" name="deptAciton" value="<?php echo $deptAciton; ?>">
                        </div>
                        <div class="mb-5">
                                    ...
                                    <?php
                                        ...
                                        while ($row2=mysqli_fetch_assoc($result)) { ?>
                                            <div id="select" class="form-check" >
                                                <div class="d-flex">
                                                    <input type="checkbox" class="form-check-input col-md-2" name="goal_id[]" value="<?php echo $row2['goal_id']; ?>" <?php echo ($goal_id==$row2['goal_id'] ? 'checked' : ''); ?>>
                                                    <label class="form-check-label">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="objDesc" class="form-control" style="height: 150px;"><?php echo $objDesc; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label col-lg-3" style="padding-top: 5px;">ผู้ลงนาม (ผ่าย มทร.อีสาน)</label>
                            <textarea name="signRmuti" class="form-control" style="height: 50px;"><?php echo $signRmuti; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label col-lg-3" style="padding-top: 5px;">พยาน (ผ่าย มทร.อีสาน)</label>
                            <textarea name="signRmutiWitness" class="form-control" style="height: 50px;"><?php echo $signRmutiWitness; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label col-lg-3" style="padding-top: 5px;">ผู้ลงนาม (ผ่ายพันธมิตร)</label>
                            <textarea name="signCo" class="form-control" style="height: 50px;"><?php echo $signCo; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label col-lg-3" style="padding-top: 5px;">พยาน (ผ่ายพันธมิตร)</label>
                            <textarea name="signCoWitness" class="form-control" style="height: 50px;"><?php echo $signCoWitness; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">ผู้ให้ข้อมูล ประกอบด้วย <span style="font-weight:300;">[ชื่อ-นามสกุล, ตำแหน่ง, สังกัด, เบอร์โทรศัพท์ภายใน, เบอร์โทรศัพท์มือถือ, E-Mail, Line ID]</span></label>
                            <textarea name="userDesc" class="form-control" style="height: 75px;"><?php echo $userDesc; ?></textarea>
                        </div>
                        <div class="d-flex mb-3 mt-5">
                            <label class="form-label col-lg-4" style="padding-top: 5px;">แนบไฟล์(MOI/MOU/MOA) <span style="color:red;">*เฉพาะไฟล์ PDF</span></label>
                            <input type="file" name="file_path" class="form-control" required>
                        </div>
                        <div class="d-flex mb-4">
                            <label class="form-label col-lg-5" style="padding-top: 5px;">แนบลิงค์ Google Drive /ข่าว ภาพร่วมพิธีลงนาม</label>
