...
<head>
  ...
  <title>ภารกิจหลัก - Admin Management</title>
    ...
    <main id="main" class="main" >
        ...
        <div class="pagetitle text-center">
            ...
            <nav class="d-flex justify-content-center mt-3">
                <a class="btn btn-light me-2" href="mission.php">พันธกิจ</a>
                <a class="btn btn-warning" href="M_mission.php">ภารกิจหลัก</a>
            </nav>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-site mb-4">
                        <h5 class="card-title text-center">ภารกิจหลัก</h5>
                    </div>
                    <div class="card-body">
                        <form action="aboutUpdate.php"  method="POST">
                            <?php
                                $sqlSelect = "SELECT * FROM about WHERE about_no=3";
