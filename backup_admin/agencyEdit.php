...
<head>
    ...
    <title>แก้ไขข้อมูลหน่วยงานใน มทร.อีสาน - Admin Management</title>
    ...
    <main id="main" class="main">
        ...
        <section>
            <div class="col-12">
                <div class="card">
                    <div class="card-site">
                        <h5 class="card-title text-center">แก้ไขข้อมูลหน่วยงาน</h5>
                    </div>
                    <div class="card-body">
                        <?php
                        $sqlQuery = "SELECT * FROM agency_university WHERE ag_id='" . $_GET['ag_id'] . "'";
                        $query = mysqli_query($conn, $sqlQuery);
                        $agency = mysqli_fetch_assoc($query);

                        $ag_id = intval($_GET['ag_id']);
                        $agency_img = $agency['agency_img'];
                        $agencyname_thai = $agency['agencyname_thai'];
                        $agencyname_eng = $agency['agencyname_eng'];
                        $abbreviation_thai = $agency['abbreviation_thai'];
                        $abbreviation_eng = $agency['abbreviation_eng'];
                        $campus = $agency['campus'];
                        ?>
                        ...
                        <div class="detail">
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <label class="col-form-label">โลโก้หน่วยงาน</label>
                                    <img src="../pic/logo/<?php echo $agency_img ?>" class="img-fluid"
                                        style="padding: 20px 95px;">
                                </div>

                                <div class="col-lg-7">
                                    <form name="agencyAdd" action="agencyUpdate.php" method="POST" enctype="multipart/form-data">
                                        <input type="hidden" name="ag_id" value="<?php echo isset($ag_id) ? $ag_id : ''; ?>">
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-8 col-lg-12 mb-2">
                                                <input name="agencyname_thai" type="text" class="form-control"
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-8 col-lg-12 mb-2">
                                                <input name="agencyname_eng" type="text" class="form-control"
