...
<head>
  ...
  <title>กิจกรรมวันนี้ - Admin Management</title>
        ...
        <div id="pagetitle">
          ...
          <nav>
            <ol class="breadcrumb mt-3">
              ...
              <li class="breadcrumb-item"><a href="index-activity.php">ข้อมูลกิจกรรมที่เพิ่มวันนี้</a></li>
            </ol>
          </nav>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card info-card customers-card">
            <div class="card-body">
              <div class="d-flex align-items-center">
                <h5 class="card-title">กิจกรรมที่เพิ่ม <span>| วันนี้</span></h5>
