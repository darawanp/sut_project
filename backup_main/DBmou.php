...
<head>
    ...
    <title>ฐานข้อมูลการทำความร่วมมือ - งานวิเทศสัมพันธ์ | มหาวิทยาลัยเทคโนโลยีราชมงคลอีสาน</title>
                    ...
                    while ($row=mysqli_fetch_assoc($result)) { ?>
                        <div class="col-lg-3 col-md-6 item <?php echo $row['campus']; ?>">
                            <div class="mou-item">
                                ...
                                <a href="<?php echo 'moAgency.php?ag_id='.$row['ag_id']; ?>" class="mou-btn">ดูเพิ่มเติม</a>
                            </div>
                        </div>     
                <?php }
            ?>
