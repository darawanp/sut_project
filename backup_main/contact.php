        ...
        <section class="contact-section">
            <div class="container">
                ...
                <!--<div class="col-lg-8 col-12 mx-auto">
                    <form class="custom-form contact-box" action="" method="post" role="form">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <input type="text" name="name" id="name" class="form-control" placeholder="ชื่อ-สกุล" required>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <input type="email" name="email" id="email" class="form-control" placeholder="อีเมล" required>
                            </div>
                        </div>
                        <input type="text" name="subject" class="form-control" placeholder="เรื่อง" required>
                        <textarea name="message" rows="5" class="form-control" id="message" placeholder="รายละเอียด" required></textarea>
                    </form>
                </div>-->
