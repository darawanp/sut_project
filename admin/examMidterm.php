...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle text-center">
            <h2>เพิ่มข้อมูลวันคุมสอบกลางภาค</h2>
            <nav class="d-flex justify-content-center">
                <ol class="breadcrumb mt-3">
                    ...
                    <li class="breadcrumb-item active">เพิ่มข้อมูลวันคุมสอบกลางภาค</a></li>
                </ol>
            </nav>
        </div>
                                    ...
                                    <div class="col-md-8 col-lg-9 mb-2">
                                        <select name="exam_type" class="form-select">
                                            <?php while ($row = $result_exam_types->fetch_assoc()): ?>
                                                <option value="<?= $row['exam_type_id'] ?>" <?= $row['exam_type_id'] == 1 ? 'selected' : '' ?>>
                                                    <?= $row['exam_types_name'] ?>
                                                </option>
                                            <?php endwhile; ?>
                                        </select>
