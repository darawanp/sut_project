...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle text-center">
            <h2>แก้ไขข้อมูลวันคุมสอบกลางภาค</h2>
            <nav class="d-flex justify-content-center">
                <ol class="breadcrumb mt-3">
                    ...
                    <li class="breadcrumb-item active">แก้ไขข้อมูลวันคุมสอบกลางภาค</li>
                </ol>
            </nav>
        </div>
        ...
        <section class="section">
            <div class="col-12">
                <div class="card">
                    <div class="card-site">
                        <h5 class="card-title text-center">แก้ไขข้อมูลวันคุมสอบกลางภาค</h5>
                    </div>
